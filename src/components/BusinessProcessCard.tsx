...
export default function BusinessProcessCard({ data }: IProps) {
  ...
  return (
    <div className="m-2 flex min-h-[252px] gap-8 rounded border-2 border-primary px-6 py-10 md:min-h-[280px] lg:min-h-[440px] lg:px-7 xl:min-h-[320px] 2xl:min-h-[232px]">
